...
public class MainViewController implements Initializable {
    ...
    public void onMenuItemSellerAction() {
        loadView("/com/example/javafx/gui/SellerList.fxml", (SellerListController controller) -> {
    ...
    public void onMenuItemDepartmentAction() {
        loadView("/com/example/javafx/gui/DepartmentList.fxml", (DepartmentListController controller) -> {
    ...
    public void onMenuItemAboutAction() {
        loadView("/com/example/javafx/gui/About.fxml", x -> {});
    }

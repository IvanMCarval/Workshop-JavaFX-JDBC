...
import com.example.javafx.db.DbException;
import com.example.javafx.db.DbIntegrityException;
...
public class DepartmentListController implements Initializable, DataChangeListener {
    ...
    public void onBtNewAction(ActionEvent event) {
        ...
        createDialogForm(obj, "/com/example/javafx/gui/DepartmentForm.fxml", parentStage);
    }
            ...
            protected void updateItem(Department obj, boolean empty) {
                ...
                button.setOnAction(
                        event -> createDialogForm(
                                obj, "/com/example/javafx/gui/DepartmentForm.fxml",Utils.currentStage(event)));
            }
        });
    }
